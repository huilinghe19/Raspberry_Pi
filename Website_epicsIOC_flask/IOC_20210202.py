...
def changeJSONFile(status, file):
    i = IOCS()
    with open('/home/pi/Templates/test/parameters.json', 'w') as f:
        data = i.getObj_parameters(str("test"), "/home/pi/Templates/Keithley/keithley2000")
